...
--
-- Servidor: localhost
-- Tiempo de generación: 23-11-2016 a las 11:48:00
...
INSERT INTO `tbl_usuarios` (`usu_id`, `usu_usuario`, `usu_nombre`, `uso_apellido1`, `uso_apellido2`, `usu_pwd`, `usu_categoria`, `usu_mail`, `tipU_id`) VALUES
(1, 'david.marin', 'david', 'marin', 'salvador', '1234', 'alta', 'david.marin@fje.edu', 1),
(2, 'sergio.jimenez', 'sergio', 'jimenez', 'garcia', '1234', 'alta', 'sergio.jumenez@fje.edu', 1),
(3, 'agnes.plans', 'agnes', 'plans', 'berenguer', '1234', 'alta', 'agnes.plans@fje.edu', 1),
(4, 'ignasi.romero', 'ignasi', 'romero', 'sanjuan', '1234', 'alta', 'ignasi.romero@fje.edu', 1),
...
ALTER TABLE `tbl_usuarios` 
  CHANGE `usu_estado` `usu_estado` VARCHAR(15) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL DEFAULT 'alta';
